...
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, ref, resolveComponent, computed, unref, createVNode, Text, Fragment, defineAsyncComponent, Suspense, nextTick, mergeProps, useSSRContext, withCtx, createTextVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu, createDefu } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash, parsePath } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/ufo/dist/index.mjs";
import { klona } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/klona/dist/index.mjs";
import { parse as parse$1 } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/destr/dist/index.mjs";
import { isEqual } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/ohash/dist/index.mjs";
import { useSeoMeta as useSeoMeta$1, useHead as useHead$1, headSymbol } from "/Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "doc",
    path: "/doc",
    component: () => import("./_nuxt/doc-rst1j7Co.js")
  },
  {
    name: "nce",
    path: "/nce",
    component: () => import("./_nuxt/nce-BjmFBc9K.js")
  },
  {
    name: "help",
    path: "/help",
    component: () => import("./_nuxt/help-TAFL06aB.js")
  },
  {
    name: "test",
    path: "/test",
    component: () => import("./_nuxt/test-BGWe3Ybu.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/index-DnaQa4E0.js")
  },
  {
    name: "setting",
    path: "/setting",
    component: () => import("./_nuxt/setting-B34rnsoV.js")
  },
  {
    name: "feedback",
    path: "/feedback",
    component: () => import("./_nuxt/feedback-DpYDrwpr.js")
  },
  {
    name: "vip",
    path: "/vip",
    meta: { "groups": ["user"] },
    component: () => import("./_nuxt/vip-CsbRW_gy.js")
  },
  {
    name: "user",
    path: "/user",
    meta: { "groups": ["user"] },
    component: () => import("./_nuxt/user-DV1Evj6T.js")
  },
  {
    name: "login",
    path: "/login",
    meta: { "groups": ["user"] },
    component: () => import("./_nuxt/login-Cic4nMkC.js")
  },
  {
    name: "dict",
    path: "/dict",
    meta: { "groups": ["words"] },
    component: () => import("./_nuxt/dict-DG3GOhNI.js")
  },
  {
    name: "words",
    path: "/words",
    meta: { "groups": ["words"] },
    component: () => import("./_nuxt/words-DLhd6kKW.js")
  },
  {
    name: "dict-list",
    path: "/dict-list",
    meta: { "groups": ["words"] },
    component: () => import("./_nuxt/dict-list-CyTT-aBB.js")
  },
  {
    name: "articles",
    path: "/articles",
    meta: { "groups": ["articles"] },
    component: () => import("./_nuxt/articles-BPJV3dPt.js")
  },
  {
    name: "book-list",
    path: "/book-list",
    meta: { "groups": ["articles"] },
    component: () => import("./_nuxt/book-list-C-irktBu.js")
  },
  {
    name: "book-id",
    path: "/book/:id()",
    meta: { "groups": ["articles"] },
    component: () => import("./_nuxt/_id_-BZOaKl6z.js")
  },
  {
    name: "book",
    path: "/book",
    meta: { "groups": ["articles"] },
    component: () => import("./_nuxt/index-CjRFiUjE.js")
  },
  {
    name: "words-test-id",
    path: "/words-test/:id()",
    meta: { "groups": ["words"] },
    component: () => import("./_nuxt/_id_-CyLE3HAV.js")
  },
  {
    name: "practice-words-id",
    path: "/practice-words/:id()",
    meta: { "groups": ["words"] },
    component: () => import("./_nuxt/_id_-BEuX4_TN.js")
  },
  {
    name: "batch-edit-article",
    path: "/batch-edit-article",
    meta: { ...__nuxt_page_meta || {}, ...{ "groups": ["articles"] } },
    component: () => import("./_nuxt/batch-edit-article-ChI7QISp.js")
  },
  {
    name: "practice-articles-id",
    path: "/practice-articles/:id()",
    meta: { "groups": ["articles"] },
    component: () => import("./_nuxt/_id_-ChwchOew.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-v9PH4nBY.js").then((m) => m.default || m)),
  empty: defineAsyncComponent(() => import("./_nuxt/empty-BNivmres.js").then((m) => m.default || m))
};
