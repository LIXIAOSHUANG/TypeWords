        ...
        if (unref(selectArticle).id) {
          ...
          if (unref(selectArticle).id === -1) {
            ...
            if (unref(selectArticle)?.question?.text) {
              _push(`<div class="mt-2 text-2xl" data-v-8478726f><div data-v-8478726f>Question: ${ssrInterpolate(unref(selectArticle)?.question?.text)}</div>`);
              if (unref(showTranslate) && (unref(displayMode) !== "card" || unref(shouldShowInlineTranslation))) {
                _push(`<div class="text-xl color-translate-second" data-v-8478726f>${ssrInterpolate(_ctx.$t("question"))}: ${ssrInterpolate(unref(selectArticle)?.question?.translate)}</div>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div>`);
            ...
            if (unref(selectArticle)?.quote?.text) {
              _push(`<div class="text-2xl" data-v-8478726f>${ssrInterpolate(unref(selectArticle)?.quote?.text)}</div>`);
            } else {
              _push(`<!---->`);
            }
            if (unref(selectArticle)?.quote?.translate && unref(showTranslate) && (unref(displayMode) !== "card" || unref(shouldShowInlineTranslation))) {
              _push(`<div class="trans-row text-xl color-translate-second" data-v-8478726f>${ssrInterpolate(unref(selectArticle)?.quote?.translate)}</div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div></article>`);
              ...
              if (unref(displayMode) !== "card") {
                ...
                if (!unref(shouldShowInlineTranslation)) {
                  ...
                  if (unref(selectArticle)?.question?.translate) {
                    _push(`<div class="mt-2" data-v-8478726f> 问题: ${ssrInterpolate(unref(selectArticle)?.question?.translate)}</div>`);
                  } else {
                    _push(`<!---->`);
                  }
                  _push(`<!--[-->`);
                  ...
                  _push(`<!--]--><div class="trans-row text-right italic" data-v-8478726f>${ssrInterpolate(unref(selectArticle)?.quote?.translate)}</div></div><!--]-->`);
                } else {
                  _push(`<!---->`);
                }
                _push(`<!--]-->`);
...
//# sourceMappingURL=_id_-BZOaKl6z.js.map
