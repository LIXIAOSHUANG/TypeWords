import { b as Space, P as PracticeLayout, S as SettingDialog, _ as __unplugin_components_2, a as __unplugin_components_8, c as Panel, C as ConflictNotice } from "./PracticeLayout-bGHxKcR-.js";
...
import { _ as __unplugin_components_4, a as __unplugin_components_5$1 } from "./eye16-regular-Cm9O3Lp0.js";
import { markRaw, openBlock, createElementBlock, createElementVNode, defineComponent, defineAsyncComponent, unref, mergeProps, withCtx, createVNode, useSSRContext, ref, computed, watch, nextTick, useTemplateRef, inject, createTextVNode, toDisplayString, provide, resolveDirective, createBlock, isRef } from "vue";
...
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderDynamicModel, ssrRenderStyle, ssrGetDirectiveProps } from "vue/server-renderer";
import { E as getDefaultArticle, t as shuffle, b as useSettingStore, c as useBaseStore, h as _nextTick, C as msToHourMinute, D as total, _ as _dateFormat, m as isMobile, a as useRuntimeStore, K as msToMinute, B as BaseIcon, T as Toast, g as getDefaultDict, w as resourceWrap, p as _getDictDataByUrl, d as cloneDeep, l as loadJsLib, G as addStat, H as getDefaultWord, J as setUserDictProp } from "./BaseIcon-Cnj57dgy.js";
import { P as PracticeArticleWordType, m as ShortcutKey, k as Tooltip, i as DICT_LIST, l as DictType, T as TourConfig, e as AppEnv, L as LIB_JS_URL } from "./env-CUoXYOyW.js";
import { A as ArticleList } from "./ArticleList-qKu_FTcS.js";
import { E as EditArticle, u as usePlaySentenceAudio, g as genArticleSectionData } from "./EditArticle-CDTYchLT.js";
import { a as useWordOptions, c as useArticleOptions } from "./dict-Dqcdsgfb.js";
import { a as useDisableEventListener, u as useStartKeyboardEventListener } from "./event-qcx2F2JA.js";
...
import { u as usePlayBeep, d as usePlayKeyboardAudio, b as usePlayWordAudio } from "./sound-fV5MruVn.js";
...
import { c as setPracticeArticleCache, b as getPracticeArticleCache } from "./cache-C4S9Fl6v.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const namePatterns = computed(() => {
      return Array.from(
        new Set(
          (props.article?.nameList ?? []).map(normalize).filter(Boolean).map((s) => s.split(/\s+/).filter(Boolean)).flat().concat(["Mr", "Mrs", "Ms", "Dr", "Miss"].map(normalize))
        )
      );
    });
    const isNameWord = () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header class="pt-10 pb-6" data-v-ee853700><div class="text-center" data-v-ee853700><span class="text-3xl" data-v-ee853700>${ssrInterpolate(unref(store).sbook.lastLearnIndex + 1)}. </span><span class="text-3xl" data-v-ee853700>${ssrInterpolate(props.article?.title ?? "")}</span>`);
      if (unref(settingStore).translate) {
        _push(`<span class="ml-6 text-2xl" data-v-ee853700>${ssrInterpolate(props.article?.titleTranslate)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (props.article?.question?.text) {
        _push(`<div class="mt-2 text-2xl" data-v-ee853700><div data-v-ee853700>Question: ${ssrInterpolate(props.article?.question?.text)}</div>`);
        if (unref(settingStore).translate) {
          _push(`<div class="text-xl color-translate-second" data-v-ee853700> 问题: ${ssrInterpolate(props.article?.question?.translate)}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function complete() {
      ...
      (void 0).umami?.track("endStudyArticle", reportData);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(ArticleList, {
                    ...
                    "active-id": unref(articleData).article.id ?? "",
...
//# sourceMappingURL=_id_-ChwchOew.js.map
