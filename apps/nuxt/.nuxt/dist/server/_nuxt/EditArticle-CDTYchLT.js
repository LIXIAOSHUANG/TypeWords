...
import { markRaw, openBlock, createElementBlock, createElementVNode, defineComponent, ref, watchEffect, unref, mergeProps, isRef, withCtx, createTextVNode, toDisplayString, useSSRContext, defineAsyncComponent, watch, createVNode, createBlock, Fragment, renderList, createCommentVNode } from "vue";
import { _ as __unplugin_components_7 } from "./play20-regular-ozWzgLyX.js";
import { _ as __unplugin_components_5$1 } from "./question-circle20-regular-ixBvu_Z4.js";
import { _ as __unplugin_components_2$1 } from "./settings20-regular-fog7odRI.js";
...
import { T as Toast, d as cloneDeep, b as useSettingStore, h as _nextTick, c as useBaseStore, a as useRuntimeStore, g as getDefaultDict, O as getDefaultArticleWord, E as getDefaultArticle, B as BaseIcon, P as _parseLRC, I as last } from "./BaseIcon-Cnj57dgy.js";
import { g as useI18n, h as _export_sfc } from "../server.mjs";
import axios from "axios";
import md5 from "md5";
import { s as TranslateEngine, f as DictId, P as PracticeArticleWordType, k as Tooltip, b as LOCAL_FILE_KEY } from "./env-CUoXYOyW.js";
...
function usePlaySentenceAudio() {
  ...
  function playSentenceAudio(sentence, ref2) {
    if (sentence.audioPosition?.length && ref2 && ref2.src) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div>`);
      if (unref(editArticle)?.sections?.length) {
        ...
        ssrRenderList(unref(editArticle).sections, (item, indexI) => {
          ...
          ssrRenderList(item, (sentence, indexJ) => {
            ...
            _push(`</div><div class="flex-[2] flex justify-end gap-1 items-center" data-v-2eecded7><div class="flex justify-end gap-2" data-v-2eecded7><div class="flex flex-col items-center justify-center" data-v-2eecded7><div data-v-2eecded7>${ssrInterpolate(sentence.audioPosition?.[0] ?? 0)}s</div><div class="flex gap-1" data-v-2eecded7>`);
            _push(ssrRenderComponent(BaseIcon, {
            ...
            if (sentence.audioPosition?.[1] !== -1) {
              _push(`<div data-v-2eecded7>${ssrInterpolate(sentence.audioPosition?.[1] ?? 0)}s</div>`);
            } else {
            ...
            _push(ssrRenderComponent(BaseIcon, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  if (sentence.audioPosition?.length && sentence.audioPosition[1]) {
                  ...
                  return [
                    sentence.audioPosition?.length && sentence.audioPosition[1] ? (openBlock(), createBlock(_component_IconFluentSpeakerEdit20Regular, { key: 0 })) : (openBlock(), createBlock(_component_IconFluentAddSquare20Regular, { key: 1 }))
                  ];
                }
              }),
              _: 2
      ...
      _push(ssrRenderComponent(unref(Dialog), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(editSentence).audioPosition?.length) {
              _push2(`<div class="flex items-center gap-2 justify-between mb-2" data-v-2eecded7${_scopeId}><div data-v-2eecded7${_scopeId}>${ssrInterpolate(unref(editSentence).text)}</div><div class="flex items-center gap-2 shrink-0" data-v-2eecded7${_scopeId}><div data-v-2eecded7${_scopeId}><span data-v-2eecded7${_scopeId}>${ssrInterpolate(unref(editSentence).audioPosition?.[0])}s</span>`);
              if (unref(editSentence).audioPosition?.[1] !== -1) {
                _push2(`<span data-v-2eecded7${_scopeId}> - ${ssrInterpolate(unref(editSentence).audioPosition?.[1])}s</span>`);
              } else {
            ...
            if (unref(preSentence)) {
              _push2(ssrRenderComponent(BaseIcon, {
                ...
                title: unref($t)("use_prev_end_seconds", { seconds: unref(preSentence)?.audioPosition?.[1] || 0 })
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
            ...
            return [
              createVNode("div", { class: "p-4 pt-0 color-main w-150 flex flex-col gap-2" }, [
                ...
                unref(editSentence).audioPosition?.length ? (openBlock(), createBlock("div", {
                  key: 0,
                  ...
                  createVNode("div", { class: "flex items-center gap-2 shrink-0" }, [
                    createVNode("div", null, [
                      createVNode("span", null, toDisplayString(unref(editSentence).audioPosition?.[0]) + "s", 1),
                      unref(editSentence).audioPosition?.[1] !== -1 ? (openBlock(), createBlock("span", { key: 0 }, " - " + toDisplayString(unref(editSentence).audioPosition?.[1]) + "s", 1)) : (openBlock(), createBlock("span", { key: 1 }, " - " + toDisplayString(unref($t)("end")), 1))
                    ]),
...
export {
  EditArticle as E,
  genArticleSectionData as g,
  syncBookInMyStudyList as s,
  usePlaySentenceAudio as u
};
//# sourceMappingURL=EditArticle-CDTYchLT.js.map
