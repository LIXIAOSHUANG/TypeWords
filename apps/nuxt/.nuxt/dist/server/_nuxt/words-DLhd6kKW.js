import { markRaw, openBlock, createElementBlock, createElementVNode, defineComponent, defineAsyncComponent, useModel, ref, unref, mergeProps, withCtx, isRef, createTextVNode, createVNode, toDisplayString, createBlock, createCommentVNode, mergeModels, useSSRContext, watch, computed, resolveDirective, Fragment, withDirectives, renderList } from "vue";
import { _ as __unplugin_components_0$2 } from "./arrow-circle-right16-regular-CmXRLB6P.js";
import { _ as __unplugin_components_3, B as Book } from "./Book-DpTMFDdY.js";
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderSlot, ssrRenderAttr, ssrGetDirectiveProps, ssrRenderClass, ssrRenderStyle, ssrRenderList } from "vue/server-renderer";
import { c as useBaseStore, b as useSettingStore, u as useNav, a as useRuntimeStore, h as _nextTick, v as myDictList, p as _getDictDataByUrl, w as resourceWrap, x as _getAccomplishDate, B as BaseIcon, l as loadJsLib, m as isMobile, T as Toast, g as getDefaultDict, t as shuffle } from "./BaseIcon-Cnj57dgy.js";
...
import { B as BaseTable, P as PracticeSettingDialog, C as ChangeLastPracticeIndexDialog, d as deleteDict } from "./dict-COqWcYxU.js";
import { useFetch } from "@vueuse/core";
import { e as AppEnv, W as WordPracticeMode, h as WordPracticeModeNameMap, O as Origin, T as TourConfig, i as DICT_LIST, L as LIB_JS_URL, A as APP_NAME } from "./env-CUoXYOyW.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function onShufflePracticeSettingOk(total) {
      (void 0).umami?.track("startShuffleStudyWord", {
        name: store.sdict.name,
        index: store.sdict.lastLearnIndex,
        perDayStudyNumber: store.sdict.perDayStudyNumber,
        total,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(store).sdict.id) {
              ...
              _push2(`<div class="text-sm flex justify-between" data-v-3bb44370${_scopeId}><span data-v-3bb44370${_scopeId}>${ssrInterpolate(progressTextLeft.value)}</span><span data-v-3bb44370${_scopeId}>${ssrInterpolate(unref(store).sdict?.lastLearnIndex)} / ${ssrInterpolate(unref(store).sdict.length)} 词</span></div></div><div class="flex items-center mt-4 gap-4" data-v-3bb44370${_scopeId}>`);
                  ...
                  unref(store).sdict.id ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                    createVNode("div", { class: "mt-4 space-y-2" }, [
                      ...
                      createVNode("div", { class: "text-sm flex justify-between" }, [
                        ...
                        createVNode("span", null, toDisplayString(unref(store).sdict?.lastLearnIndex) + " / " + toDisplayString(unref(store).sdict.length) + " 词", 1)
                      ])
                    ]),
...
//# sourceMappingURL=words-DLhd6kKW.js.map
