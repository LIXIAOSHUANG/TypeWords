import { markRaw, openBlock, createElementBlock, createElementVNode, ref, watch, computed } from "vue";
import { c as useBaseStore, b as useSettingStore, t as shuffle, d as cloneDeep, M as splitIntoN, N as getRandomN, a as useRuntimeStore, g as getDefaultDict, w as resourceWrap, p as _getDictDataByUrl, o as detail } from "./BaseIcon-Cnj57dgy.js";
import { i as DICT_LIST, f as DictId, l as DictType, e as AppEnv } from "./env-CUoXYOyW.js";
...
function useGetDict() {
  ...
  async function loadDict(dict) {
    ...
    if (dict && dict.id) {
      if (!dict?.articles?.length && !dict?.custom && ![DictId.articleCollect].includes(dict.en_name || dict.id) && !dict?.is_default) {
        fetching.value = true;
...
export {
  ...
  useArticleOptions as c,
  getCurrentStudyWord as g,
  useGetDict as u
};
//# sourceMappingURL=dict-Dqcdsgfb.js.map
