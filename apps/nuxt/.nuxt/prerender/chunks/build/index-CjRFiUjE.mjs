        ...
        if (unref(selectArticle).id) {
          ...
          if (unref(selectArticle).id === -1) {
            ...
            if ((_d = (_c = unref(selectArticle)) == null ? void 0 : _c.question) == null ? void 0 : _d.text) {
              _push(`<div class="mt-2 text-2xl" data-v-7cbe97f1><div data-v-7cbe97f1>Question: ${ssrInterpolate((_f = (_e = unref(selectArticle)) == null ? void 0 : _e.question) == null ? void 0 : _f.text)}</div>`);
              if (unref(showTranslate) && (unref(displayMode) !== "card" || unref(shouldShowInlineTranslation))) {
                _push(`<div class="text-xl color-translate-second" data-v-7cbe97f1>${ssrInterpolate(_ctx.$t("question"))}: ${ssrInterpolate((_h = (_g = unref(selectArticle)) == null ? void 0 : _g.question) == null ? void 0 : _h.translate)}</div>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div>`);
            ...
            if ((_j = (_i = unref(selectArticle)) == null ? void 0 : _i.quote) == null ? void 0 : _j.text) {
              _push(`<div class="text-2xl" data-v-7cbe97f1>${ssrInterpolate((_l = (_k = unref(selectArticle)) == null ? void 0 : _k.quote) == null ? void 0 : _l.text)}</div>`);
            } else {
              _push(`<!---->`);
            }
            if (((_n = (_m = unref(selectArticle)) == null ? void 0 : _m.quote) == null ? void 0 : _n.translate) && unref(showTranslate) && (unref(displayMode) !== "card" || unref(shouldShowInlineTranslation))) {
              _push(`<div class="trans-row text-xl color-translate-second" data-v-7cbe97f1>${ssrInterpolate((_p = (_o = unref(selectArticle)) == null ? void 0 : _o.quote) == null ? void 0 : _p.translate)}</div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div></article>`);
              ...
              if (unref(displayMode) !== "card") {
                ...
                if (!unref(shouldShowInlineTranslation)) {
                  ...
                  if ((_r = (_q = unref(selectArticle)) == null ? void 0 : _q.question) == null ? void 0 : _r.translate) {
                    _push(`<div class="mt-2" data-v-7cbe97f1> \u95EE\u9898: ${ssrInterpolate((_t = (_s = unref(selectArticle)) == null ? void 0 : _s.question) == null ? void 0 : _t.translate)}</div>`);
                  } else {
                    _push(`<!---->`);
                  }
                  _push(`<!--[-->`);
                  ...
                  _push(`<!--]--><div class="trans-row text-right italic" data-v-7cbe97f1>${ssrInterpolate((_v = (_u = unref(selectArticle)) == null ? void 0 : _u.quote) == null ? void 0 : _v.translate)}</div></div><!--]-->`);
                } else {
                  _push(`<!---->`);
                }
                _push(`<!--]-->`);
...
//# sourceMappingURL=index-CjRFiUjE.mjs.map
