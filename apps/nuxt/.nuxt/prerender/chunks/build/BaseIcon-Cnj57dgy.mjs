...
import { shallowReactive, defineComponent, mergeProps, withCtx, createVNode, renderSlot, render as render$4, ref, computed, markRaw, openBlock, createElementBlock, createElementVNode, useSSRContext, nextTick } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
...
import { S as SAVE_DICT_KEY, e as AppEnv, c as SAVE_SETTING_KEY, i as DictType, g as DictId, W as WordPracticeType, j as WordPracticeMode, h as Tooltip, k as ENV, D as DefaultShortcutKeyMap, P as PracticeArticleWordType } from './env-CUoXYOyW.mjs';
import axios from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/axios/index.js';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSlot, ssrInterpolate } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
...
import duration from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/dayjs/plugin/duration.js';
...
const Toast = (options) => {
  ...
  const instance = {
    close: () => {
      var _a, _b, _c;
      (_c = (_b = (_a = vnode.component) == null ? void 0 : _a.exposed) == null ? void 0 : _b.close) == null ? void 0 : _c.call(_b);
    }
  };
  ...
  getters: {
    ...
    sdict() {
      ...
      if (this.word.studyIndex >= 0) {
        return (_a = this.word.bookList[this.word.studyIndex]) != null ? _a : getDefaultDict();
      }
    ...
    sbook() {
      var _a;
      return (_a = this.article.bookList[this.article.studyIndex]) != null ? _a : {};
    },
    currentBookProgress() {
...
function getDefaultDict(val = {}) {
  ...
  return {
    ...
    sync: false,
    ...val,
    words: shallowReactive((_a = val.words) != null ? _a : []),
    articles: shallowReactive((_b = val.articles) != null ? _b : []),
    statistics: shallowReactive((_c = val.statistics) != null ? _c : [])
  };
}
...
export { resourceWrap as A, BaseIcon as B, Close as C, addDict as D, myDictList as E, _getAccomplishDate as F, groupBy as G, total as H, getDefaultArticle as I, getDefaultWord as J, setUserDictProp as K, last as L, addStat as M, _parseLRC as N, getDefaultArticleWord as O, msToMinute as P, syncSetting as Q, Toast as T, _dateFormat as _, useRuntimeStore as a, useSettingStore as b, useBaseStore as c, cloneDeep as d, checkAndUpgradeSaveSetting as e, checkAndUpgradeSaveDict as f, getDefaultDict as g, _nextTick as h, __unplugin_components_0 as i, jump2Feedback as j, shakeCommonDict as k, loadJsLib as l, isMobile as m, convertToWord as n, _getDictDataByUrl as o, detail as p, reverse as q, request as r, sleep as s, shuffle as t, useNav as u, msToHourMinute as v, debounce as w, _getAccomplishDays as x, splitIntoN as y, getRandomN as z };
//# sourceMappingURL=BaseIcon-Cnj57dgy.mjs.map
