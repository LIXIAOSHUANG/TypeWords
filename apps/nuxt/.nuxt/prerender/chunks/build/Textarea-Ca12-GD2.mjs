...
import { defineComponent, ref, watch, computed, nextTick, mergeProps, useSlots, provide, inject, useSSRContext } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderStyle, ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderTeleport, ssrRenderSlot } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    var _a;
    const props = __props;
    const innerValue = ref((_a = props.modelValue) != null ? _a : "");
    watch(
      () => props.modelValue,
      (v) => innerValue.value = v != null ? v : ""
    );
...
export { Option as O, Select as S, Textarea as T };
//# sourceMappingURL=Textarea-Ca12-GD2.mjs.map
