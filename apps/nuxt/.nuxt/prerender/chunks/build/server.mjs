import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import * as Vue from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { hasInjectionContext, inject, defineComponent, shallowRef, h, resolveComponent, getCurrentInstance as getCurrentInstance$1, computed, createElementBlock, provide, cloneVNode, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, mergeProps, withCtx, createTextVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, getCurrentScope, toRef, nextTick, isReadonly, toRaw, isRef, isShallow, isReactive } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/ofetch/dist/node.mjs';
import { n as baseURL } from '../nitro/nitro.mjs';
...
import { getContext, executeAsync } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, getRequestURL, appendHeader, getRequestHeader, getCookie, setCookie, deleteCookie } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/h3/dist/index.mjs';
import { setActivePinia, createPinia, shouldHydrate } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/pinia/dist/pinia.prod.cjs';
import { createDefu, defu } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/defu/dist/defu.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue-router/vue-router.node.mjs';
import { parseQuery, hasProtocol, joinURL, withQuery, isScriptProtocol, withTrailingSlash, withoutTrailingSlash, parsePath } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/ufo/dist/index.mjs';
...
import { parse as parse$1 } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
...
import { isEqual } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/ohash/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "doc",
    path: "/doc",
    component: () => import('./doc-rst1j7Co.mjs')
  },
  {
    name: "nce",
    path: "/nce",
    component: () => import('./nce-BjmFBc9K.mjs')
  },
  {
    name: "help",
    path: "/help",
    component: () => import('./help-TAFL06aB.mjs')
  },
  {
    name: "test",
    path: "/test",
    component: () => import('./test-BGWe3Ybu.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-DnaQa4E0.mjs')
  },
  {
    name: "setting",
    path: "/setting",
    component: () => import('./setting-B34rnsoV.mjs')
  },
  {
    name: "feedback",
    path: "/feedback",
    component: () => import('./feedback-DpYDrwpr.mjs')
  },
  {
    name: "vip",
    path: "/vip",
    meta: { "groups": ["user"] },
    component: () => import('./vip-CsbRW_gy.mjs')
  },
  {
    name: "user",
    path: "/user",
    meta: { "groups": ["user"] },
    component: () => import('./user-DV1Evj6T.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: { "groups": ["user"] },
    component: () => import('./login-Cic4nMkC.mjs')
  },
  {
    name: "dict",
    path: "/dict",
    meta: { "groups": ["words"] },
    component: () => import('./dict-DG3GOhNI.mjs')
  },
  {
    name: "words",
    path: "/words",
    meta: { "groups": ["words"] },
    component: () => import('./words-DLhd6kKW.mjs')
  },
  {
    name: "dict-list",
    path: "/dict-list",
    meta: { "groups": ["words"] },
    component: () => import('./dict-list-CyTT-aBB.mjs')
  },
  {
    name: "articles",
    path: "/articles",
    meta: { "groups": ["articles"] },
    component: () => import('./articles-BPJV3dPt.mjs')
  },
  {
    name: "book-list",
    path: "/book-list",
    meta: { "groups": ["articles"] },
    component: () => import('./book-list-C-irktBu.mjs')
  },
  {
    name: "book-id",
    path: "/book/:id()",
    meta: { "groups": ["articles"] },
    component: () => import('./_id_-BZOaKl6z.mjs')
  },
  {
    name: "book",
    path: "/book",
    meta: { "groups": ["articles"] },
    component: () => import('./index-CjRFiUjE.mjs')
  },
  {
    name: "words-test-id",
    path: "/words-test/:id()",
    meta: { "groups": ["words"] },
    component: () => import('./_id_-CyLE3HAV.mjs')
  },
  {
    name: "practice-words-id",
    path: "/practice-words/:id()",
    meta: { "groups": ["words"] },
    component: () => import('./_id_-BEuX4_TN.mjs')
  },
  {
    name: "batch-edit-article",
    path: "/batch-edit-article",
    meta: { ...__nuxt_page_meta || {}, ...{ "groups": ["articles"] } },
    component: () => import('./batch-edit-article-ChI7QISp.mjs')
  },
  {
    name: "practice-articles-id",
    path: "/practice-articles/:id()",
    meta: { "groups": ["articles"] },
    component: () => import('./_id_-ChwchOew.mjs')
  }
];
  ...
  en: [
    {
      ...
      load: () => import(
        './en-DpOyQV3c.mjs'
        /* webpackChunkName: "locale_en_46json_e80480de" */
      ),
      cache: true
    }
  ],
  zh: [
    {
      ...
      load: () => import(
        './zh-D7Gm0KZ5.mjs'
        /* webpackChunkName: "locale_zh_46json_ea3a808b" */
      ),
      cache: true
    }
  ],
  es: [
    {
      ...
      load: () => import(
        './es-CL5fN5g8.mjs'
        /* webpackChunkName: "locale_es_46json_fe553d5f" */
      ),
      cache: true
    }
  ],
  fr: [
    {
      ...
      load: () => import(
        './fr-BX-ks-w8.mjs'
        /* webpackChunkName: "locale_fr_46json_1beb71b6" */
      ),
      cache: true
    }
  ],
  pt: [
    {
      ...
      load: () => import(
        './pt-BS-c_Ydx.mjs'
        /* webpackChunkName: "locale_pt_46json_c9034204" */
      ),
      cache: true
    }
  ],
  de: [
    {
      ...
      load: () => import(
        './de-DHIuX8N1.mjs'
        /* webpackChunkName: "locale_de_46json_890cb04c" */
      ),
      cache: true
    }
  ],
  ru: [
    {
      ...
      load: () => import(
        './ru-eOK3St1g.mjs'
        /* webpackChunkName: "locale_ru_46json_83b08ec9" */
      ),
      cache: true
    }
  ],
  uk: [
    {
      ...
      load: () => import(
        './uk-cKgkQD6k.mjs'
        /* webpackChunkName: "locale_uk_46json_2398a4ad" */
      ),
      cache: true
    }
  ],
  ja: [
    {
      ...
      load: () => import(
        './ja-DHWQ6-xl.mjs'
        /* webpackChunkName: "locale_ja_46json_10327c19" */
      ),
      cache: true
    }
  ],
  ko: [
    {
      ...
      load: () => import(
        './ko-9j60ZXnp.mjs'
        /* webpackChunkName: "locale_ko_46json_af5b940d" */
      ),
      cache: true
    }
  ],
  th: [
    {
      ...
      load: () => import(
        './th-BRoDUxUY.mjs'
        /* webpackChunkName: "locale_th_46json_68c22063" */
      ),
      cache: true
    }
  ],
  vi: [
    {
      ...
      load: () => import(
        './vi-N4ilCJtk.mjs'
        /* webpackChunkName: "locale_vi_46json_e2fe69e2" */
      ),
      cache: true
    }
  ],
  id: [
    {
      ...
      load: () => import(
        './id-CoRXDj1C.mjs'
        /* webpackChunkName: "locale_id_46json_69a85f97" */
      ),
      cache: true
    }
  ],
  tw: [
    {
      ...
      load: () => import(
        './tw-BZzeZN5-.mjs'
        /* webpackChunkName: "locale_tw_46json_77b7bff4" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/5wb-JNvi"}/${locale}/messages.json`, { headers });
...
const i18n_19v21r6K1zdMR19WY1buFv7wSXagWynDr1PPElFzQrU = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/5wb-JNvi"}/${locale}/messages.json`));
...
const directives_server_CKLC3nCUNGplVt60JISBXloabJbhFokXe7cEpaF_3A0 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.vueApp.directive("opacity", (el, binding) => {
  });
  nuxtApp.vueApp.directive("loading", {});
});
let routes;
const prerender_server_plVKKzTvbXDD_hKHSLq3T2y9S48MaJAuuJYmW0ZgGZg = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
...
const plugins = [
  ...
  directives_server_CKLC3nCUNGplVt60JISBXloabJbhFokXe7cEpaF_3A0,
  prerender_server_plVKKzTvbXDD_hKHSLq3T2y9S48MaJAuuJYmW0ZgGZg,
  ssg_detect_JQT9b_sVERYDW__eN0wuiqDH6nql0nVptMbJ3IvFy8E
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-v9PH4nBY.mjs').then((m) => m.default || m)),
  empty: defineAsyncComponent(() => import('./empty-BNivmres.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen center flex-col" }, _attrs))}><h1>${ssrInterpolate(__props.error?.statusCode)}</h1><h2>${ssrInterpolate(__props.error?.message)}</h2>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/words" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`返回首页`);
          } else {
...
export { __nuxt_component_0$1 as _, useSeoMeta as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry_default as default, useRequestFetch as e, fetchDefaults as f, useI18n as g, _export_sfc as h, useRuntimeConfig as i, useHead as j, useRequestEvent as k, useRoute as u };
