import { defineComponent, ref, provide, watch, computed, resolveDirective, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, createCommentVNode, isRef, markRaw, inject, nextTick, Fragment, renderList, createElementBlock, createElementVNode, withDirectives, createTextVNode, defineAsyncComponent, useModel, useSSRContext } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrGetDirectiveProps, ssrInterpolate, ssrRenderStyle, ssrRenderClass, ssrRenderAttrs, ssrRenderList } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
import { _ as __unplugin_components_7$3 } from './home20-regular-BqrUvY-4.mjs';
import { _ as __unplugin_components_7$2 } from './play20-regular-ozWzgLyX.mjs';
import { _ as __unplugin_components_4$2 } from './arrow-clockwise20-regular-RJbPEZbx.mjs';
import { b as useSettingStore, a as useRuntimeStore, c as useBaseStore, h as _nextTick, J as getDefaultWord, B as BaseIcon, g as getDefaultDict, A as resourceWrap, o as _getDictDataByUrl, T as Toast, d as cloneDeep, t as shuffle, K as setUserDictProp, L as last, M as addStat, v as msToHourMinute, l as loadJsLib } from './BaseIcon-Cnj57dgy.mjs';
...
import { C as ChannelIcons } from './ChannelIcons-BDL8HMec.mjs';
import { o as ShortcutKey, j as WordPracticeMode, h as Tooltip, r as DICT_LIST, n as WordPracticeStage, W as WordPracticeType, e as AppEnv, l as WordPracticeModeStageMap, s as WordPracticeModeNameMap, m as WordPracticeStageNameMap, p as SoundFileOptions, L as LIB_JS_URL, T as TourConfig } from './env-CUoXYOyW.mjs';
...
import { u as useWordOptions, g as getCurrentStudyWord, a as __unplugin_components_5 } from './dict-Dqcdsgfb.mjs';
...
import { P as PracticeLayout, a as Panel, C as ConflictNotice, S as SettingDialog, _ as __unplugin_components_2$2, b as __unplugin_components_8, c as Space } from './PracticeLayout-bGHxKcR-.mjs';
import { _ as __unplugin_components_7$1, B as BaseList } from './BaseList-BGyirn9c.mjs';
import { _ as __unplugin_components_10 } from './translate-jzfWdenW.mjs';
import { a as __unplugin_components_4$1, _ as __unplugin_components_5$1 } from './eye16-regular-Cm9O3Lp0.mjs';
import { _ as __unplugin_components_3$1, W as WordItem } from './WordItem-QVJUwi53.mjs';
...
import { S as Select, O as Option } from './Textarea-Ca12-GD2.mjs';
import { M as MiniDialog } from './MiniDialog-DIRP4Q9a.mjs';
import { V as VolumeIcon } from './VolumeIcon--ng6Uza7.mjs';
import { b as usePlayBeep, c as usePlayCorrect, d as usePlayKeyboardAudio, a as usePlayWordAudio, e as useTTsPlayAudio, u as usePlayAudio, g as getAudioFileUrl } from './sound-fV5MruVn.mjs';
import { E as Empty } from './Empty-DqqzidIv.mjs';
import { watchOnce } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/@vueuse/core/dist/index.js';
import { R as RadioGroup, a as Radio } from './Radio-WTKpkBn7.mjs';
import { s as setPracticeWordCache, g as getPracticeWordCache } from './cache-C4S9Fl6v.mjs';
  ...
  setup(__props) {
    ...
    watch(model, async (newVal) => {
      ...
      if (newVal) {
        ...
        (_a = (void 0).umami) == null ? void 0 : _a.track("endStudyWord", {
    ...
    const encouragementText = computed(() => {
      ...
      if (rate >= 95) return "\u{1F389} " + $t("encouragement_95");
      if (rate >= 85) return "\u{1F44D} " + $t("encouragement_85");
      if (rate >= 70) return "\u{1F4AA} " + $t("encouragement_70");
      return "\u{1F31F} " + $t("encouragement_default");
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconFluentArrowClockwise20Regular = __unplugin_components_4$2;
      const _component_IconFluentPlay20Regular = __unplugin_components_7$2;
      const _component_IconFluentHome20Regular = __unplugin_components_7$3;
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(practiceTaskWords).shuffle.length) {
              _push2(`<!--[--> \u{1F3AF} ${ssrInterpolate(unref($t)("review_complete"))}<!--]-->`);
            } else {
              _push2(`<!--[--> \u{1F389} ${ssrInterpolate(unref($t)("daily_task_complete"))}<!--]-->`);
            }
                ...
                createVNode("div", { class: "text-center relative" }, [
                  createVNode("div", { class: "text-3xl font-bold mb-2 bg-gradient-to-r from-purple-500 to-purple-700 bg-clip-text text-transparent" }, [
                    unref(practiceTaskWords).shuffle.length ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                      createTextVNode(" \u{1F3AF} " + toDisplayString(unref($t)("review_complete")), 1)
                    ], 64)) : (openBlock(), createBlock(Fragment, { key: 1 }, [
                      createTextVNode(" \u{1F389} " + toDisplayString(unref($t)("daily_task_complete")), 1)
                    ], 64))
                  ]),
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(props.stages, (i) => {
        var _a;
        _push(`<!--[-->`);
        if (((_a = i == null ? void 0 : i.children) == null ? void 0 : _a.length) && i.active) {
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconFluentEyeOff16Regular = __unplugin_components_4$1;
      ...
      const _component_IconFluentTranslateOff16Regular = __unplugin_components_7$1;
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-a2ddf398>${(_a = highlightedText.value) != null ? _a : ""}</div>`);
    };
  }
});
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function reset() {
      ...
      if (settingStore.wordSound) {
        if (settingStore.wordPracticeType !== WordPracticeType.Dictation) {
          (_a = volumeIconRef.value) == null ? void 0 : _a.play(400, true);
        }
      }
    ...
    function repeat() {
      setTimeout(() => {
        ...
        wordRepeatCount++;
        inputLock = false;
        if (settingStore.wordSound) (_a = volumeIconRef.value) == null ? void 0 : _a.play();
    ...
    async function onTyping(e) {
      ...
      if (settingStore.wordPracticeType === WordPracticeType.Dictation) {
        if (e.code === "Space") {
          if (input.value.length && (input.value.length >= word.length || !word.includes(" "))) {
            if (input.value.toLowerCase() === word.toLowerCase()) {
              ...
              playBeep();
              if (settingStore.wordSound) (_b = volumeIconRef.value) == null ? void 0 : _b.play();
              emit("wrong");
            }
            showWordResult.value = true;
            return;
        ...
        showWordResult.value = true;
        emit("wrong");
        if (settingStore.wordSound) (_c = volumeIconRef.value) == null ? void 0 : _c.play();
        inputLock = false;
        onTyping(e);
      } else {
        let right2 = false;
        ...
        if (right2) {
          ...
          wrong.value = letter;
          playBeep();
          if (settingStore.wordSound) (_d = volumeIconRef.value) == null ? void 0 : _d.play();
          setTimeout(() => {
    ...
    function play() {
      ...
      (_a = volumeIconRef.value) == null ? void 0 : _a.play();
    }
      ...
      if (__props.word.word.length) {
            ...
            if (_push2) {
              ...
              if (unref(settingStore).wordPracticeType === unref(WordPracticeType).Dictation) {
                ...
                if (unref(settingStore).dictation && !unref(showFullWord)) {
                  _push2(`<span class="letter" data-v-ff0bc64a${_scopeId}>${ssrInterpolate(unref(displayWord).split("").map((v) => v === " " ? "\xA0" : "_").join(""))}</span>`);
                } else {
                ...
                createVNode("div", {
                  ...
                  unref(settingStore).wordPracticeType === unref(WordPracticeType).Dictation ? (openBlock(), createBlock("div", { key: 0 }, [
                    ...
                    unref(settingStore).dictation && !unref(showFullWord) ? (openBlock(), createBlock("span", {
                      key: 2,
                      class: "letter"
                    }, toDisplayString(unref(displayWord).split("").map((v) => v === " " ? "\xA0" : "_").join("")), 1)) : (openBlock(), createBlock("span", {
                      key: 3,
                      class: "letter"
        ...
        ssrRenderList(__props.word.trans, (v) => {
          ...
          if (!unref(settingStore).dictation || unref(showWordResult) || unref(showFullWord)) {
            ...
            _push(`<span data-v-ff0bc64a>${(_a2 = hideWordInTranslation(v.cn, __props.word.word)) != null ? _a2 : ""}</span>`);
          }
          _push(`</div>`);
        });
        ...
        if ((_b = (_a = __props.word) == null ? void 0 : _a.sentences) == null ? void 0 : _b.length) {
        ...
        if ((_d = (_c = __props.word) == null ? void 0 : _c.phrases) == null ? void 0 : _d.length) {
        ...
        if (unref(settingStore).translate || !unref(settingStore).dictation) {
          _push(`<!--[-->`);
          if ((_f = (_e = __props.word) == null ? void 0 : _e.synos) == null ? void 0 : _f.length) {
        ...
        if ((_h = (_g = __props.word) == null ? void 0 : _g.etymology) == null ? void 0 : _h.length) {
        ...
        if (((_j = (_i = __props.word) == null ? void 0 : _i.relWords) == null ? void 0 : _j.root) && false) ;
        else {
          _push(`<!---->`);
        }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const word = computed(() => {
      var _a;
      return (_a = data.value.words[data.value.index]) != null ? _a : getDefaultWord();
    });
    const prevWord = computed(() => {
      var _a, _b;
      return (_b = (_a = data.value.words) == null ? void 0 : _a[data.value.index - 1]) != null ? _b : void 0;
    });
    ...
    async function continueStudy() {
      ...
      if (settingStore.wordPracticeMode === WordPracticeMode.Shuffle) {
        temp.shuffle = shuffle(store.sdict.words.filter((v) => !ignoreList.includes(v.word))).slice(
          0,
          (_a = runtimeStore.routeData.total) != null ? _a : temp.shuffle.length
        );
...
//# sourceMappingURL=_id_-BEuX4_TN.mjs.map
