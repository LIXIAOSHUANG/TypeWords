...
import { defineComponent, ref, watch, computed, resolveComponent, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, isRef, markRaw, createElementBlock, createElementVNode, useSSRContext } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderStyle, ssrRenderTeleport } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
...
import { _ as __unplugin_components_7 } from './home20-regular-BqrUvY-4.mjs';
...
import { _ as __unplugin_components_2 } from './settings20-regular-fog7odRI.mjs';
import { _ as __unplugin_components_0, a as __unplugin_components_1 } from './text-underline-double20-regular-Urqfz4U4.mjs';
import { c as useBaseStore, a as useRuntimeStore, b as useSettingStore, B as BaseIcon, k as shakeCommonDict, Q as syncSetting } from './BaseIcon-Cnj57dgy.mjs';
...
import { o as ShortcutKey, a as APP_VERSION, S as SAVE_DICT_KEY, g as DictId, b as LOCAL_FILE_KEY, c as SAVE_SETTING_KEY, e as AppEnv } from './env-CUoXYOyW.mjs';
import { M as MigrateDialog } from './MigrateDialog-DTKAmkmx.mjs';
import { u as useTheme } from './theme-4yK9pI7O.mjs';
import { u as useUserStore } from './user-BLvskJR1.mjs';
import { set, get } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/idb-keyval/dist/index.js';
...
function useInit() {
  ...
  async function init() {
    ...
    (_a = (void 0).umami) == null ? void 0 : _a.track("host", { host: (void 0).location.host });
  }
  return init;
}
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span data-v-39d3a68a>\u4E3B\u9875</span></div><div class="${ssrRenderClass([{ active: (_a = unref(route).path) == null ? void 0 : _a.includes("/words") }, "nav-item"])}" data-v-39d3a68a>`);
      _push(ssrRenderComponent(_component_IconFluentTextUnderlineDouble20Regular, null, null, _parent));
      _push(`<span data-v-39d3a68a>\u5355\u8BCD</span></div><div class="${ssrRenderClass([{ active: (_b = unref(route).path) == null ? void 0 : _b.includes("/articles") }, "nav-item"])}" data-v-39d3a68a>`);
...
//# sourceMappingURL=default-v9PH4nBY.mjs.map
