import { defineComponent, ref, watch, mergeProps, unref, useSSRContext } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderStyle, ssrRenderAttr, ssrInterpolate } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    var _a, _b, _c;
    const props = __props;
    const min = (_a = props.min) != null ? _a : 0;
    const max = (_b = props.max) != null ? _b : 100;
    (_c = props.step) != null ? _c : 1;
    ref(null);
    ref(false);
    ref(0);
    ref(0);
...
export { Slider as S };
//# sourceMappingURL=Slider-ibM1Ch1E.mjs.map
