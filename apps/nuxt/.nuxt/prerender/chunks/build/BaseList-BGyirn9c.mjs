import { markRaw, openBlock, createElementBlock, createElementVNode, defineComponent, ref, computed, watch, nextTick, resolveComponent, mergeProps, withCtx, createVNode, renderSlot, useSSRContext } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderList } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
    ...
    function scrollViewToCenter(index) {
      ...
      nextTick(() => {
        ...
        if (props.list.length > limit) {
          ...
          (_c = (_b = listRef.value) == null ? void 0 : _b.children[index]) == null ? void 0 : _c.scrollIntoView({ block: "center", behavior: "smooth" });
        }
      });
    }
    watch(
    ...
    watch(
      ...
      () => {
        ...
        nextTick(() => {
          var _a, _b;
          if (props.list.length > limit) {
            (_a = listRef.value) == null ? void 0 : _a.scrollToItem(0);
          } else {
            (_b = listRef.value) == null ? void 0 : _b.scrollTo(0, 0);
          }
        });
      }
    );
...
export { BaseList as B, __unplugin_components_7 as _ };
//# sourceMappingURL=BaseList-BGyirn9c.mjs.map
