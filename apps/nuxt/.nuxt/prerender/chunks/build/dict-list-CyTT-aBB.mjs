...
import { defineComponent, computed, ref, watch, resolveDirective, withCtx, mergeProps, unref, isRef, createTextVNode, toDisplayString, createVNode, withDirectives, openBlock, createBlock, Fragment, renderList, useSSRContext } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrGetDirectiveProps, ssrInterpolate, ssrRenderList, ssrRenderClass } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
import { u as useNav, a as useRuntimeStore, b as useSettingStore, c as useBaseStore, A as resourceWrap, G as groupBy, h as _nextTick, B as BaseIcon, g as getDefaultDict, l as loadJsLib } from './BaseIcon-Cnj57dgy.mjs';
...
import { D as DictList } from './DictList-CwtT5r7B.mjs';
...
import { r as DICT_LIST, L as LIB_JS_URL, T as TourConfig } from './env-CUoXYOyW.mjs';
    ...
    const searchList = computed(() => {
      if (searchKey.value) {
        ...
        return dict_list.value.filter((item) => {
          var _a, _b, _c, _d;
          return item.id.toLowerCase().includes(s) || item.name.toLowerCase().includes(s) || item.category.toLowerCase().includes(s) || item.tags.join("").replace("\u6240\u6709", "").toLowerCase().includes(s) || ((_d = (_b = (_a = item == null ? void 0 : item.url) == null ? void 0 : _a.toLowerCase) == null ? void 0 : (_c = _b.call(_a)).includes) == null ? void 0 : _d.call(_c, s));
        });
      }
      return [];
    });
...
export { dictList as default };
//# sourceMappingURL=dict-list-CyTT-aBB.mjs.map
