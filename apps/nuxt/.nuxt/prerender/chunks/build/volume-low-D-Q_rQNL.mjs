...
const __unplugin_components_2 = markRaw({ name: "bx-volume-full", render: render$1 });
const _hoisted_1 = {
  viewBox: "0 0 24 24",
  width: "1.2em",
  height: "1.2em"
...
const __unplugin_components_1 = markRaw({ name: "bx-volume-low", render });

export { __unplugin_components_1 as _, __unplugin_components_2 as a };
//# sourceMappingURL=volume-low-D-Q_rQNL.mjs.map
