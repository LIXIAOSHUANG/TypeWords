import { defineComponent, ref, watch, mergeProps, unref, useAttrs, computed, markRaw, openBlock, createElementBlock, createElementVNode, useSSRContext } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderStyle, ssrInterpolate } from 'file:///Users/lishuang/Documents/workspace/web/study/vue/TypeWords-master/node_modules/vue/server-renderer/index.mjs';
...
import { b as LOCAL_FILE_KEY, k as ENV } from './env-CUoXYOyW.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const setAudioRefValue = (key, value) => {
      var _a;
      if ((_a = instance.value) == null ? void 0 : _a.audioRef) {
        switch (key) {
          case "currentTime":
      ...
      new Proxy(
        ...
        },
        {
          get(target, key) {
            ...
            if (key === "currentTime") return (_b = (_a = instance.value) == null ? void 0 : _a.audioRef) == null ? void 0 : _b.currentTime;
            if (key === "played") return (_d = (_c = instance.value) == null ? void 0 : _c.audioRef) == null ? void 0 : _d.played;
            if (key === "src") return (_f = (_e = instance.value) == null ? void 0 : _e.audioRef) == null ? void 0 : _f.src;
            if (key === "volume") return (_h = (_g = instance.value) == null ? void 0 : _g.audioRef) == null ? void 0 : _h.volume;
            if (key === "playbackRate") return (_j = (_i = instance.value) == null ? void 0 : _i.audioRef) == null ? void 0 : _j.playbackRate;
            if (key === "play") (_l = (_k = instance.value) == null ? void 0 : _k.audioRef) == null ? void 0 : _l.play();
            if (key === "pause") (_n = (_m = instance.value) == null ? void 0 : _m.audioRef) == null ? void 0 : _n.pause();
            return target[key];
          },
          set(_, key, value) {
            setAudioRefValue(key, value);
...
export { ArticleAudio as A };
//# sourceMappingURL=ArticleAudio-HKnHxiX1.mjs.map
